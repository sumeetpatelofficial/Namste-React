      ...
      restaurants: [
...

        {
          info: {
            ...
            cloudinaryImageId: "siwxgtmitarjpoejllre",
...

        {
          info: {
            ...
            cloudinaryImageId: "uutfsi1qajb1kabgxy1g",
            locality: "Old Padra Road",
            areaName: "Old Padra Road",
            costForTwo: "₹200 for two",
...

        {
          info: {
            ...
            cloudinaryImageId: "ivjbcoavvbisjnhlkddo",
            locality: "Kp Infinity",
            areaName: "Vadiwadi",
...

        {
          info: {
            id: "243133",
            name: "Firangi Bake",
            cloudinaryImageId: "jnfnya2enuskezxmpoim",
            locality: "ONGC Road",
            areaName: "Manjalpur",
            costForTwo: "₹400 for two",
            cuisines: [
...

        {
          info: {
            id: "301189",
            name: "PVR Cafe",
            cloudinaryImageId: "oqcscxdacy5ahfz26tan",
            locality: "Bhyali Road",
            areaName: "Bhayli",
            costForTwo: "₹300 for two",
...

        {
          info: {
            ...
            cloudinaryImageId: "so2pmhkzzwjofehkn1br",
            locality: "Fatehgunj Main Road",
            areaName: "Fatehgunj",
            costForTwo: "₹300 for two",
